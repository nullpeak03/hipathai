...
console.log("[inngest] Registered functions:", generateRoadmapFn.id, generateLessonFn.id, streakReminderFn.id)

// Create handler once at module level
const handler = serve({
  client: inngest,
  functions: [generateRoadmapFn, generateLessonFn, streakReminderFn],
})
