    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose max-w-none mt-8 space-y-6 text-sm leading-relaxed">
          ...
          <p>To generate adaptive roadmaps via our AI providers, personalize lessons, and keep your mentor context-aware. We do not sell data.</p>
          <h2 className="text-lg font-semibold">Storage</h2>
          <p>Supabase (EU/US) with RLS. Data is tied to your Clerk ID. You can request export or deletion via <Link href="/contact" className="text-primary underline">Contact</Link>.</p>
          <h2 className="text-lg font-semibold">Cookies</h2>
          <p>Essential cookies for auth (Clerk) and preferences. See <Link href="/cookies" className="text-primary underline">Cookie Policy</Link>.</p>
          <h2 className="text-lg font-semibold">Contact</h2>
          <p>Questions? <Link href="/contact" className="text-primary underline">Contact us</Link> or email privacy@hipathai.me.</p>
        </div>
      </main>
