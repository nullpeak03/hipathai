    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose max-w-none mt-8 space-y-6 text-sm leading-relaxed">
          ...
          <p>Provide accurate onboarding info. Do not abuse NIMs APIs (rate-limited). Content is AI-generated — verify critical info.</p>
          ...
          <p>Roadmaps/lessons are generated via Nvidia NIMs 5-model fallback. We aim for accuracy but do not guarantee. Report errors via <Link href="/contact" className="text-[#6C5BFF] underline">Contact</Link>.</p>
