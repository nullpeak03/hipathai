  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-zinc-500 mt-2">We’d love to hear from you.</p>
        <div className="mt-8 space-y-6">
          <div className="border rounded-xl p-6 bg-gray-50">
            <h2 className="font-semibold">Email</h2>
            <p className="text-sm text-zinc-600 mt-1">support@hipathai.me • privacy@hipathai.me</p>
            <p className="text-xs text-zinc-500 mt-2">For data export/deletion, include your Clerk email.</p>
          </div>
          <div className="border rounded-xl p-6">
            <h2 className="font-semibold">Links</h2>
            <div className="flex flex-wrap gap-3 mt-3 text-sm">
              <Link href="/privacy" className="text-[#6C5BFF] underline">Privacy</Link>
              <Link href="/terms" className="text-[#6C5BFF] underline">Terms</Link>
              <Link href="/cookies" className="text-[#6C5BFF] underline">Cookies</Link>
              <a href="https://github.com/nullpeak03/hipathai" target="_blank" className="text-[#6C5BFF] underline">GitHub</a>
            </div>
          </div>
