    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-zinc-950">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-4 sm:p-6 max-w-7xl w-full mx-auto">
          ...
          <div className="mt-6">
            {active==="Profile" && <Card className="p-6"><h3 className="font-semibold">Overview</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4"><div className="text-center p-4 bg-gray-50 dark:bg-zinc-800 rounded-xl"><div className="font-bold text-[#6C5BFF]">Lv.{gam.level}</div><div className="text-xs text-zinc-500">Level</div></div><div className="text-center p-4 bg-gray-50 dark:bg-zinc-800 rounded-xl"><div className="font-bold text-amber-600">{gam.xp}</div><div className="text-xs">XP Points</div></div><div className="text-center p-4 bg-gray-50 dark:bg-zinc-800 rounded-xl"><div className="font-bold">{gam.streak}d</div><div className="text-xs">Current Streak</div></div><div className="text-center p-4 bg-gray-50 dark:bg-zinc-800 rounded-xl"><div className="font-bold">{(gam as any).bestStreak ?? 0}d</div><div className="text-xs">Best Streak</div></div></div></Card>}
